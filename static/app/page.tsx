            ...
            <div className="mt-16">
                ...
                <div className="flex gap-6 mt-6 max-w-5xl">
                    ...
                    <div className="space-y-5">
                        <h3 className="text-xl">2015-2016: Just an historical success or also a sudden "Big Four" underperform?</h3>
                        <p className="text-gray-300">Claudio Ranieri's Leicester City achieved a first historical League title for the "Foxes". 
                            Was it just a great achievement or also a sudden performance crisis of the historical big clubs? 
                        </p>
                        <a href="/insights/insight1" className="px-6 py-3 bg-purple-600 hover:bg-purple-800 text-white rounded-lg shadow-lg transition-all">
                            See More
                        </a>
                    </div>
                </div>
                <div className="flex gap-6 mt-6 max-w-5xl">
                    ...
                    <div className="space-y-5">
                        ...
                        <p className="text-gray-300">In 2012-2013, the "Citizens" won their first Premier League title in dramatic fashion, coming 
                        ...
                        <a href="/insights/insight2" className="px-6 py-3 bg-purple-600 hover:bg-purple-800 text-white rounded-lg shadow-lg transition-all">
                            See More
                        </a>
                    </div>
                </div>
